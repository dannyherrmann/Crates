...
public class UserAlbumRepository : BaseRepository, IUserAlbumRepository
{
    public UserAlbumRepository(IConfiguration configuration) : base(configuration) { }
    ...
    public List<UserAlbum> GetUserAlbums(int userId, int? pageNumber, int? pageSize, SortOrder sortOrder, string? genres = null, string? styles = null, string? searchCriterion = null)
    {
        using (var conn = Connection)
        {
            ...
            {
                var sql = @"SELECT ua.id,
                                ua.userId,
                                ua.dateAdded AS userDateAdded,
                                al.id AS albumId,
